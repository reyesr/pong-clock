...
# Project:  clock.pro
# Template: app
# Command: /home/rodrigo/opt/Qt/5.5/gcc_64/bin/qmake -o Makefile clock.pro
#############################################################################
...
CXXFLAGS      = -pipe -I/usr/include/SDL2 -D_REENTRANT -O2 -Wall -O2 -std=c++0x -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -I../../opt/Qt/5.5/gcc_64/mkspecs/linux-g++
QMAKE         = /home/rodrigo/opt/Qt/5.5/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
COMPRESS      = gzip -9f
DISTNAME      = clock1.0.0
DISTDIR = /home/rodrigo/projects/pong-clock/.tmp/clock1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/rodrigo/opt/Qt/5.5/gcc_64
LIBS          = $(SUBLIBS) -L/usr/lib/x86_64-linux-gnu -lSDL2 -lSDL2_image 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../opt/Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		clock.pro src/simpleclock.h \
		src/ponggame.h \
		src/graphics.h \
		src/utils.h \
		src/resourcefont.h \
		src/sdlcontext.h \
		src/resources.h src/main.cpp \
		src/simpleclock.cpp \
		src/ponggame.cpp \
		src/graphics.cpp \
		src/utils.cpp \
...
Makefile: clock.pro ../../opt/Qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf ../../opt/Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		../../opt/Qt/5.5/gcc_64/mkspecs/common/unix.conf \
		../../opt/Qt/5.5/gcc_64/mkspecs/common/linux.conf \
		../../opt/Qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		../../opt/Qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
...
main.o: src/main.cpp src/sdlcontext.h \
		src/resources.h \
		src/resourcefont.h \
		src/utils.h \
		src/simpleclock.h \
...
simpleclock.o: src/simpleclock.cpp src/simpleclock.h \
		src/sdlcontext.h \
		src/resources.h \
		src/resourcefont.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o simpleclock.o src/simpleclock.cpp

ponggame.o: src/ponggame.cpp src/ponggame.h \
		src/sdlcontext.h \
		src/graphics.h \
		src/utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ponggame.o src/ponggame.cpp
...
resourcefont.o: src/resourcefont.cpp src/resourcefont.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o resourcefont.o src/resourcefont.cpp

sdlcontext.o: src/sdlcontext.cpp src/sdlcontext.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sdlcontext.o src/sdlcontext.cpp
